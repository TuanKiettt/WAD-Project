...
<%@ page isELIgnored = "false" %>
	<div class="row">
		...
		<c:if test="${not empty userobj }">
			<div class="col-md-3">
			<div class=mr-auto>
				<a href="cart.jsp"><i class="fas fa-cart-plus fa-2x text-primary"></i></a>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex">
					<button class="btn btn-light my-2 my-sm-0 p-2" type="submit" style="border-radius:15px "><i class="fa-solid fa-gear"></i> Setting</button>
